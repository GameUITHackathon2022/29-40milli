...
class _ApiService implements ApiService {
  ...
  @override
  Future<PostAddCampaignResponse> addCampaign(addCampaign) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(addCampaign.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<PostAddCampaignResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = PostAddCampaignResponse.fromJson(_result.data!);
    return value;
  }
